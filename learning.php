...
<!-- Mini Hero -->
<div class="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 px-4 mb-12 shadow-lg">
    <div class="container mx-auto text-center relative z-10">
        <h1 class="text-4xl font-extrabold mb-4">Complete Curriculum</h1>
        <p class="text-lg text-blue-100 max-w-2xl mx-auto">Explore all grade levels and subjects available on Hesten's
            Learning.</p>
    </div>
    <!-- Decor -->
    <div class="absolute top-0 right-0 p-10 opacity-10 text-9xl"><i class="fas fa-book"></i></div>
</div>
