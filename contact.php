        ...
        <div class="space-y-8 animate-fade-in-up">
            <div class="bg-content-bg p-8 rounded-3xl shadow-lg border-l-8 border-primary relative overflow-hidden">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="w-12 h-12 rounded-full bg-blue-100 text-primary flex items-center justify-center text-xl shrink-0">
                            <i class="fas fa-envelope"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-text-default text-lg">Email Us</h3>
                            <a href="mailto:admin@hestena62.com"
                                class="text-primary hover:underline text-lg">admin@hestena62.com</a>
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="w-12 h-12 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center text-xl shrink-0">
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="w-12 h-12 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center text-xl shrink-0">
                        ...
                        <div>
                            ...
                            <div class="flex gap-4 mt-2">
                                <a href="#"
                                    class="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-text-secondary hover:bg-primary hover:text-white transition-all"
                                    aria-label="Twitter">
            ...
            <div class="bg-gradient-to-r from-secondary to-accent p-8 rounded-3xl shadow-lg text-white text-center">
                ...
                <a href="/help-center.php"
                    class="inline-block bg-white text-primary px-6 py-3 rounded-full font-bold hover:bg-blue-50 transition-colors shadow-md">
                    Visit Help Center
                </a>
            </div>
        </div>
