...
<head>
    ...
    <meta name="keywords"
        content="<?php echo isset($pageKeywords) ? htmlspecialchars($pageKeywords) : 'education, learning disabilities, accessibility, personalized learning, special education'; ?>" />
    <meta name="author"
        content="<?php echo isset($pageAuthor) ? htmlspecialchars($pageAuthor) : 'Hesten\'s Learning'; ?>" />
    ...
    <meta property="og:title"
        content="<?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Hesten\'s Learning'; ?>" />
    <meta property="og:description"
        content="<?php echo isset($pageDescription) ? htmlspecialchars($pageDescription) : 'Personalized, accessible learning for everyone.'; ?>" />
...
<body class="antialiased font-sans overflow-x-hidden selection:bg-primary selection:text-white">
    ...
    <div id="a11y-settings-panel"
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button id="a11y-close-button" class="text-text-secondary hover:text-text-default p-2 rounded-full"
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex space-x-2">
                    <button id="theme-light"
                        ...
                        aria-label="Light Mode"><i class="fas fa-sun"></i> Light</button>
                    <button id="theme-dark"
                        ...
                        aria-label="Dark Mode"><i class="fas fa-moon"></i> Dark</button>
                    <button id="theme-contrast"
                        ...
                        aria-label="High Contrast"><i class="fas fa-low-vision"></i> High</button>
                </div>
            </div>
            ...
            <div>
                ...
                <div id="font-selection-buttons" class="grid grid-cols-1 gap-2">
                    <button type="button" data-font="Inter"
                        class="font-selector py-2 px-3 rounded border text-left text-sm">Standard (Inter)</button>
                    <button type="button" data-font="Open Dyslexic"
                        class="font-selector py-2 px-3 rounded border text-left text-sm"
                        style="font-family: 'Open Dyslexic';">Dyslexic Friendly</button>
                    <button type="button" data-font="Lexend"
                        class="font-selector py-2 px-3 rounded border text-left text-sm"
                        style="font-family: 'Lexend';">Lexend (High Legibility)</button>
                </div>
            </div>
            ...
            <div>
                <label for="line-height-slider" class="block text-sm font-medium mb-2 text-text-default">Line Spacing
                    (<span id="line-height-value">1.6</span>)</label>
                <input type="range" id="line-height-slider" min="1.3" max="2.2" step="0.1" value="1.6"
                    class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
            </div>
            ...
            <div class="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center justify-between">
                    <label for="toggle-reduced-motion" class="text-sm font-medium text-text-default">Reduce
                        Motion</label>
    ...
    <div id="announcement-bar"
        ...
        <p class="text-sm font-medium">
            <i class="fas fa-hammer mr-2"></i> Work in Progress: We are updating sections daily. Feedback? Email <a
                href="mailto:admin@hestena62.com" class="underline hover:text-blue-200">admin@hestena62.com</a>
        </p>
        <button id="close-announcement"
            class="absolute right-2 top-1/2 transform -translate-y-1/2 text-white/80 hover:text-white p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-white"
    ...
    <header class="bg-header-bg shadow-lg sticky top-0 z-40 transition-colors duration-300">
        <div class="container mx-auto px-4 py-3">
            <nav class="flex items-center justify-between flex-wrap" aria-label="Main navigation">
                <!-- Logo -->
                <a class="flex items-center flex-shrink-0 text-white mr-6 focus:outline-none focus:ring-2 focus:ring-white rounded-lg p-1"
                    href="/">
                    <img src="Images/6791421e-7ca7-40bd-83d3-06a479bf7f36.png" alt=""
                        class="rounded-full h-10 w-10 mr-3 border-2 border-white/20"
                        onerror="this.src='https://placehold.co/40x40?text=HL';" />
                    <span
                        class="font-bold text-xl tracking-tight"><?php echo isset($pageTitle) && $pageTitle !== '' ? $pageTitle : 'Hesten\'s Learning'; ?></span>
                </a>
                ...
                <!-- Nav Links -->
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden transition-all duration-300 ease-in-out"
                    id="nav-content">
                    ...
                    <div class="relative mt-4 lg:mt-0">
                        <form id="search-form" action="/search.php" method="GET" role="search">
                            ...
                            <div class="relative group">
                                ...
                                <i
                                    class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-white transition-colors"></i>
                            </div>
                        </form>
                    </div>
                </div>
