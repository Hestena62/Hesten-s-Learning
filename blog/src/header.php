...
<script>
          ...
          typography: (theme) => ({
            DEFAULT: {
              css: {
                ...
                strong: { color: 'var(--color-text-default)' },
                blockquote: {
  ...
  <style>
    ...
    .high-contrast .prose h1, .high-contrast .prose h2, .high-contrast .prose h3, .high-contrast .prose h4 {
        color: var(--color-primary);
    }
...
<body class="antialiased font-sans">
  ...
  <!--Popup-->
  <?php if (isset($welcomeMessage) && isset($welcomeParagraph)): ?>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      // Only run if the popup exists on this page
      if (popup && closeBtn) {
        ...
        try {
          if (localStorage.getItem(POPUP_STORAGE_KEY) === 'true') {
            ...
            return; // Don't attach listener or focus
             ...
             // If not dismissed, show it (it's hidden by default to prevent flash)
             popup.style.display = 'flex';
          }
        } catch (e) {
          console.warn("Could not read from localStorage", e);
          popup.style.display = 'flex'; // Show if localStorage fails
        }
  ...
  <div id="announcement-bar"
    ...
    <p class="text-sm">I am working on each section a little at a time. If you would like a certain feature please email me at <a href="mailto:admin@hestena62.com" class="font-bold underline text-blue-200 hover:text-white">admin@hestena62.com</a></p>
    ...
    <div class="container mx-auto px-4 py-4">
      <nav class="flex items-center justify-between flex-wrap" aria-label="Main navigation">
        ...
        <a class="flex items-center flex-shrink-0 text-white mr-6" href="/">
          ...
          <span class="font-semibold text-xl tracking-tight"><?php echo isset($pageTitle) && $pageTitle !== '' ? htmlspecialchars($pageTitle) : 'Hesten\'s Learning'; ?></span>
        </a>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden" id="nav-content">
          <div class="text-sm lg:flex-grow">
            ...
            <a href="/blog.php"
              class="block mt-4 lg:inline-block lg:mt-0 text-gray-200 hover:text-white mr-4 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-white">
              <i class="fas fa-newspaper mr-1" aria-hidden="true"></i> Blog
            </a>
            <a href="/about.php"
              class="block mt-4 lg:inline-block lg:mt-0 text-gray-200 hover:text-white mr-4 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <a href="/admin.php"
              class="block mt-4 lg:inline-block lg:mt-0 text-gray-200 hover:text-white mr-4 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-white">
              <i class="fas fa-user-shield mr-1" aria-hidden="true"></i> Admin
            </a>
            <!-- === END NEW LINKS === -->
